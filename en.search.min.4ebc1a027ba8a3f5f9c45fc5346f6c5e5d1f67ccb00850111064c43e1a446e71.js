...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.9728960c1832b9ed0007ff589e4f74d58ffd51ced977d5a6d2807a12691064a5.js',function(){input.required=false;search();});}
