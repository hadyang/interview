...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.4afc880ea58f1f32b75c88252ca6e5d7aead049a7e7399f32d08449c7b446a8f.js',function(){input.required=false;search();});}
