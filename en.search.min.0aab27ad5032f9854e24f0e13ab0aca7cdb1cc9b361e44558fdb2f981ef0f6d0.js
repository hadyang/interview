...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.f56c616168a848010482901389ac449cd9ca431a1a79474ad9805dcbe665f616.js',function(){input.required=false;search();});}
