...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.6328f9da4fdfce52842e9044787c8bcdd17a87907edb735d4345f23e63c9a4e6.js',function(){input.required=false;search();});}
